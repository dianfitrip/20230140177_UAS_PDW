...
<div class="bg-white p-6 rounded-lg shadow-md mb-8">
    ...
    <form action="modul.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <select name="praktikum_id" id="praktikum_id" class="shadow border rounded w-full py-2 px-3 text-gray-700 focus:ring-purple-500 focus:border-purple-500" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_modul" id="nama_modul" class="shadow border rounded w-full py-2 px-3 text-gray-700 focus:ring-purple-500 focus:border-purple-500" value="<?php echo htmlspecialchars($modul_to_edit['nama_modul'] ?? ''); ?>" required>
        </div>
        <div class="mb-4">
            <label for="file_materi" class="block text-gray-700 text-sm font-bold mb-2">File Materi (PDF, DOCX, PPTX):</label>
            <input type="file" name="file_materi" id="file_materi" class="shadow border rounded w-full py-2 px-3 text-gray-700 focus:ring-purple-500 focus:border-purple-500">
        ...
        <button type="submit" name="submit" class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded transition-colors duration-300">Simpan Modul</button>
    </form>
</div>
        ...
        <tbody class="text-gray-700">
            ...
            <tr class="border-b hover:bg-purple-50">
                ...
                <td class="py-3 px-4">
                    ...
                    <a href="../uploads/<?php echo htmlspecialchars($row['file_materi']); ?>" target="_blank" class="text-indigo-600 hover:underline">
                        Download
                    </a>
