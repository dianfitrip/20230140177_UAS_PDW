...
<head>
    ...
    <style>
        /* Optional: Add custom scrollbar styles if desired for the main content area */
    ...
    <div class="flex flex-grow">
        <aside class="w-64 bg-purple-800 text-white flex flex-col">
            <div class="p-6 text-center border-b border-purple-700">
                ...
                <p class="text-sm text-purple-200 mt-1"><?php echo htmlspecialchars($_SESSION['nama']); ?></p>
            </div>
            <nav class="flex-grow">
                <ul class="space-y-2 p-4">
                    ...
                    <li>
                        <a href="matkul.php" class="<?php echo ($activePage == 'matkul') ? $activeClass : $inactiveClass; ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
                    ...
                    <li>
                        <a href="users.php" class="<?php echo ($activePage == 'users') ? $activeClass : $inactiveClass; ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
                            <svg class="w-5 h-5 mr-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372m-10.512-4.536A9.42 9.42 0 015.625 6.375a9.42 9.42 0 0112.75 0g" /></svg>
        ...
        <main class="flex-1 p-6 lg:p-10 overflow-y-auto custom-scrollbar">
            <header class="flex items-center justify-between mb-8">
                <h1 class="text-3xl font-bold text-purple-800"><?php echo $pageTitle ?? 'Dashboard'; ?></h1>
                <a href="../logout.php" class="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-300">
                    Logout
                </a>
            </header>
