...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden transform hover:-translate-y-1 transition-transform duration-300">
        <div class="p-6">
            ...
            <a href="course_detail.php?id=<?php echo $row['id']; ?>" class="block text-center w-full bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-4 rounded-lg transition-colors duration-300">
                Lihat Detail & Tugas
            </a>
        </div>
    </div>
    ...
    <div class="col-span-3 bg-white p-6 rounded-lg shadow-md text-center">
        ...
        <a href="courses.php" class="text-indigo-600 hover:underline mt-2 inline-block">Silahkan Daftar Terlebih Dahulu!.</a>
    </div>
    <?php
    endif;
    $stmt->close();
    // HAPUS BARIS INI: $conn->close(); <-- Ini yang menyebabkan error
    ?>
</div>
